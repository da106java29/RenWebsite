...
Create table IF NOT EXISTS MEMBER (
	...
	id varchar(16) not null COMMENT "User Accoud or login Account, Not Null",
    ...
    email varchar(50) null COMMENT "USER EMAIL, Use for Permission, And send some Messages for User OR Administrator.",
...
insert into MEMBER(ID, PWD, PERMISSION, EMAIL, REMARK)
	values ("user1", "user1", "0", "", "This test user account.");
